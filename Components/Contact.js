  ...
  return (
    <div className="contact-container">
      <div className="contact-content">
        <h1>Contact Us</h1>
        <p>Thank you for considering our course registeration application for your  needs. We're here to assist you in any way we can. Whether you have questions, need support, or want to provide feedback, we're just a message away.</p>
      </div>

      <div className="contact-methods">
        <div className="contact-method">
          <h3>Email</h3>
          <p>For general inquiries and support, please email us at <a href="mailto:contact@yourcrapp.com">contact@yourcrapp.com</a>. Our dedicated support team will respond promptly to assist you with any issues or questions you may have.</p>
        </div>
        ...
        <div className="contact-method">
          ...
          <p>Join our vibrant user community on our forums. Here, you can connect with other users, share tips and tricks, and get answers to your questions from experienced users and our support staff. Visit our forums at <a href="https://community.youracrapp.com">community.yourcrapp.com</a>.</p>
        </div>
        ...
        <div className="contact-method">
          ...
          <p>Your cr App, Inc.<br />123 Main Street<br />Suite 456<br />Cbe,TN</p>
        </div>
      </div>
    </div>
  );

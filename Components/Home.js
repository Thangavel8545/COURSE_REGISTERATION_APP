  ...
  return (
    ...
    <nav id='nav'>
     ...
     <div class='form-group'>
      ...
      <input class="form-control"
      type='text'
      nameholder='Enter the Course Name'
      value={buyer}
      ...
      <button id='but' class="btn btn-info" onClick={handlePost}>ADD THE COURSE</button>
      <button id='but' class="btn btn-danger" onClick={handleGet}>SHOW THE COURSES</button>
          <button id='but' class="btn btn-info" onClick={handlePut}>UPDATE CART</button>

      <div class='form-group'>
      <label>DELETE COURSE FROM CART:</label>
      <input class="form-control"
      type='number'
